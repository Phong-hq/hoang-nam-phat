<template>
  <section class="py-14">
    <div class="container mx-auto px-4 max-w-screen-xl">
      ...
      <div v-if="brands.length" class="flex gap-1.5 overflow-x-auto scrollbar-none -mt-4 mb-6">
        <button v-for="brand in brands" :key="brand.id" @click="activeBrand = brand"
          class="px-3 py-1.5 rounded-full text-xs font-semibold whitespace-nowrap transition-colors flex-shrink-0 border"
