      ...
      <div class="flex items-center gap-1 mt-2">
        <div class="flex gap-px">
          <svg
            ...
            :key="i"
            class="w-3 h-3"
            :class="i <= Math.round(product.rating) ? 'fill-warning text-warning' : 'fill-base-200 text-base-200'"
            viewBox="0 0 20 20"
          >
            <path
        ...
        <span class="text-[10px] text-base-content/40">({{ product.ratingCount }})</span>
      </div>
