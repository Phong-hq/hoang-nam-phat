      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div class="flex flex-col gap-4">
          ...
          <div class="bg-white rounded-2xl border border-gray-200 shadow p-4 sm:p-6 flex items-start gap-4">
            <div class="bg-primary/10 rounded-xl p-3 flex-shrink-0">
...
const socialItems = computed(() => {
  const items = [
    ...
    {
      label: 'Messenger', href: socialRecord.value?.messenger, type: 'svg' as const,
      icon: 'M12 0C5.3733 0 0 5.0197 0 11.2568c0 3.5511 1.7215 6.7191 4.4108 8.7898V24l4.0446-2.2126c1.0762.298 2.2222.457 3.4446.457 6.6267 0 12-5.0197 12-11.2568C24 5.0197 18.6267 0 12 0zm1.1911 15.1451l-3.0605-3.2634-5.9694 3.2634 6.5623-6.9843 3.1352 3.2634 5.8944-3.2634-6.5623 6.9843z',
    },
    {
